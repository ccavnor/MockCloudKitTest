...
- MockCloudKitFramework: a framework for unit and integration testing that uses mock objects and mutable internal state to mimic CloudKit operations and allow for deterministic testing.
- MockCloudKitTestProject: the associated test project to MockCloudKitFramework. It contains Unit and Integration tests of MockCloudKitFramework for examples (with documentation) of how to use MockCloudKitFramework in your project.

MockCloudKitFramework uses [DocC](https://developer.apple.com/documentation/docc) markup for documentation, so that docs can be built and distributed seperately from the project.
